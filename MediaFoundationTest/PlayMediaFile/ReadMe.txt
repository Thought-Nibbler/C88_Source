========================================================================
    ダイナミック リンク ライブラリ: PlayMediaFile プロジェクトの概要
========================================================================

この PlayMediaFile DLL は、AppWizard により作成されました。

このファイルには、PlayMediaFile アプリケーションを構成する各ファイルの内容の概要が含まれています。

PlayMediaFile.vcxproj
